...
describe("Certicate component", () => {
  ...
  it("should render base64 icons with default props", () => {
    ...
    expect(iconsElement.props.children[0].props.base64).toEqual(BASE64);
  });
  ...
  it("should render base64 icons with defined props", () => {
    ...
    expect(iconsElement.props.children[0].props.base64).toEqual(
      mockProps[0].icons[0].base64,
    );
  });
  ...
  it("should render base64 technology name with default props", () => {
    ...
    expect(nameElement.props.children[0].props.name).toEqual("Lorem");
  });
  ...
  it("should render base64 technology name with defined props", () => {
    ...
    expect(nameElement.props.children[0].props.name).toEqual(
      mockProps[0].icons[0].name,
    );
  });
});
